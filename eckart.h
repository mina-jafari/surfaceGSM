...
namespace Eckart
{
    ...
    void Eckart_align(double* xyzreact, double* xyzprod, double tol, 
            double* total_thetas, int max_iter, double* masses, int natoms);
    void Eckart_align(double* xyzreact, double* xyzprod, double* masses, int natoms);
    void Eckart_align(double* xyzreact, double* xyzprod, double tol, 
            double* total_thetas, int max_iter, double* masses, int natoms, double rfrac);
    ...
    void Eckart_align_string_and_gradients(double** angs, double** ang_gradients, 
            int nstring, double* masses, int natoms);
