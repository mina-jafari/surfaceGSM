...
#if !UNRESTRICTED
#if !CATION
//  inpfile << " PM6 NOSYM 1SCF GRADIENTS CHARGE=-1 " << endl;
  inpfile << " PM6 NOSYM 1SCF GRADIENTS " << endl;
#else
  inpfile << " PM6 NOSYM CHARGE=1 1SCF GRADIENTS " << endl;
#endif
#else
#if !CATION 
#if !TRIPLET
  inpfile << " PM6 NOSYM UHF 1SCF GRADIENTS " << endl;
#else
  inpfile << " PM6 NOSYM UHF TRIPLET 1SCF GRADIENTS " << endl;
#endif
#else
  inpfile << " PM6 NOSYM UHF CHARGE=1 1SCF GRADIENTS " << endl;
#endif
#endif
  inpfile << "   MOPAC run " << endl;
  inpfile << "   ready to go? " << endl;
